...
[![Version](https://img.shields.io/badge/version-v1.0.2-blue.svg)](https://github.com/tozn607/photographicstyles-v3)
...
- **Footer**: Displays `PhotoStyle v1.0.2 • Author: @tozn607`.
...
photostyle --version
# Output: PhotoStyle v1.0.2 • Author: @tozn607 (Core 0.4.2)
